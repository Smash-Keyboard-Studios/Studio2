...
/// <summary>
/// Base script to handle the spawning of enemies.
/// </summary>
public class SpawnHandler : MonoBehaviour
{
    /// <summary>
    /// The scriptable object that stores the enemy prefabs and their corresponding numerical id.
    /// </summary>
    ...
    protected List<Transform> trackingEnemies = new List<Transform>();
    ...
    protected bool SpawnAI(int id, List<GameObject> spawnLocationToUse, Vector3 playerPosition, float minRadius, float maxRadius)
    {
    ...
    private Vector3? GetRandomSpawnLocation(List<GameObject> spawnLocationToUse, Vector3 playerPosition, float minRadius = 30f, float maxRadius = 100f)
    {
        ...
        foreach (GameObject possibleSpawnLocation in spawnLocationToUse)
        {
    ...
    protected void RandomiseList(ref List<int> list)
    {
