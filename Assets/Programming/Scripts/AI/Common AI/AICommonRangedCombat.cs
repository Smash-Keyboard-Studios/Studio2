...
// And a few adjustments by Alex K
public class AICommonRangedCombat : AIBase, IAnimationStateUpdator
{
    ...
    [SerializeField] private float speedReduction = 0f;
    [SerializeField] private float retreatDistance = 10f;
    [SerializeField] protected float retreatCooldown = 6f;
    [SerializeField] protected float retreatTimer = 0f;
    #region Awake
